...
//   return (
//     <div className='dark:bg-gradient-to-r border-2 rounded-md dark:from-[#010314] dark:to-[#0f0728]'>
//         <div className="p-2 rounded-md shadow-md w-full">
//           <img src={image} alt="instructor image" className="object-cover object-center w-full rounded-md h-72 dark:bg-gray-500" />
//           <div className="mt-6 mb-2">
//             <span className="block md:text-2xl text-xl font-bold pb-3 dark:text-white tracking-widest uppercase text-center font-Pt dark:font-Merienda">{instructor_name}</span>
//             <h2 className="text-xl text-center font-semibold tracking-wide dark:text-white">Contact Me: <span className='text-info dark:text-warning lowercase'>{email}</span></h2>
//           </div>
//         </div>
//     </div>
//   )
