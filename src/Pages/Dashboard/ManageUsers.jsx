                      ...
                      <tr key={user._id}>
                        ...
                        <td className="p-2 whitespace-nowrap">
                          <div className="text-lg text-center flex gap-10">
                            ...
                            <button disabled={instructor} onClick={() => handleUpdateRoleInstructor(user)} className={`px-10 py-[5px] border-2 flex items-center gap-2  bg-info text-white hover:bg-warning rounded-md ${instructor?'opacity-50 cursor-no-drop' : ''}`}>make instructor <RiUserStarFill className='text-xl' /></button>
                            <button onClick={() => handleDeleteUser(user._id)} className='awesome-btn px-10 py-[2px] rounded-full'>Delete</button>
                          </div>
                        </td>
                      </tr>
                    );
