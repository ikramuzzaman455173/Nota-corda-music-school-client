...
const SelectClasses = () => {
  return (
    <>
      <h3 className='text-center my-10 font-bold tracking-wider text-slate-500 dark:text-white underline decoration-double md:text-3xl text-xl font-Pt dark:font-Merienda'>Total Selected Classes Are: <span className='text-info dark:text-warning'>0</span></h3>
              ...
              <table className="table-auto w-full">
                ...
                <tbody className="text-sm divide-y dark:text-white divide-gray-100">
                  <tr>
                    ...
                    <td className="p-2 whitespace-nowrap">
                      <div className="text-lg text-center"><button className='awesome-btn px-10 py-[2px] rounded-full'>pay</button></div>
                    </td>
                  </tr>
